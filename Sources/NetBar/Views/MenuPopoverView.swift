...
struct MenuPopoverView: View {
    ...
    @State private var selectedPeriod: ProcessTrafficMonitor.TimePeriod = .fiveMinutes
    ...
    var body: some View {
        ...
        .onAppear {
            selectedPeriod = processTrafficMonitor.selectedPeriod
            preloadVisibleIcons()
        }
        .onChange(of: selectedPeriod) { newValue in
            processTrafficMonitor.selectedPeriod = newValue
        }
