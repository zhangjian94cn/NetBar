...
- 日期: 2026-08-25
- 状态: superseded（地址面假设已由 [2026-08-28-split-management-and-sharing-address-planes-adr.md](2026-08-28-split-management-and-sharing-address-planes-adr.md) 取代；自愈部分另见 [2026-08-26-mac-mini-preferred-route-self-healing-adr.md](2026-08-26-mac-mini-preferred-route-self-healing-adr.md)）
